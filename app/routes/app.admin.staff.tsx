      ...
      <div className="staff-shell">
        ...
        <SectionTabs
          ...
          tabs={[
            ...
            { value: "access", label: "ShopOps access" },
          ]}
        />
        {result ? (
        ...
        {tab === "access" ? (
          <>
            <p className="staff-section-copy">
              Manage who can open ShopOps Studio and which locations they can
              view.
            </p>
            <InlineNotice>
              The store owner always has access and uses one ShopOps user seat.
            </InlineNotice>
          </>
        ) : null}
